    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <Card>
        ...
        <CardContent className="text-muted-foreground space-y-4">
            ...
            <p>By downloading, accessing, or using the ImageRights AI mobile application ("Service"), you agree to be bound by these Terms of Use ("Terms"). If you disagree with any part of the terms, you may not access the Service. These Terms apply to all visitors, users, and others who access or use the Service.</p>
            ...
            <p>The Service and its original content (excluding content provided by users), features, and functionality are and will remain the exclusive property of ImageRights AI and its licensors. You retain full ownership of the images you upload. By using the Service, you grant us a limited, non-exclusive, worldwide, royalty-free license to use, process, and transmit your uploaded images for the sole purpose of providing the analysis service to you.</p>
            ...
            <p>In no event shall ImageRights AI, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
